...
function s(t) {
    const {interval: e, strategy: n, minRandomInterval: s, maxRandomInterval: o, counter: u} = t;
    if ("function" === typeof n) return t.strategy(u);
    switch (n) {
      case r.fixed:
        return i[r.fixed](e);

      case r.incremental:
        return i[r.incremental](u, e);

      case r.exponential:
        return i[r.exponential](u, e);

      case r.random:
        return i[r.random](u, e, s, o);
...
const u = /^([a-z][a-z0-9+\-.]*:)?\/\//i;

const c = t.DI.createInterface("IHttpClient", (t => t.singleton(HttpClient)));
...
class HttpClient {
    ...
    buildRequest(t, e) {
        ...
        if (Object.prototype.isPrototypeOf.call(Request.prototype, t)) {
            ...
            n = new Request(l(this.baseUrl, t), u);
        }
